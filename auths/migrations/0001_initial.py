    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign_up_with', models.CharField(default='email', max_length=60)),
                ('profile_photo', models.ImageField(blank=True, null=True, upload_to=functools.partial(django_uuid_upload._upload_to_uuid_impl, *(), **{'make_dir': False, 'path': 'profile_photos/', 'remove_qs': True}))),
